...
# ==========================================================
# kahfimoodtzyy Full Protect + Same Admin Theme v11
#
# RULE FINAL:
# Admin utama:
# - full akses semua
...
#
# Install:
#   MAIN_ADMIN_ID=1 bash kahfi-full-protect-same-theme-final-v11.sh
# atau:
#   MAIN_ADMIN_ID=1 bash kahfi-full-protect-same-theme-final-v11.sh /var/www/pterodactyl
# ==========================================================
...
print_status "Starting kahfimoodtzyy Full Protect v11..."
...
# Disable legacy v7/v8 owner restriction only before v11 is installed.
# Do not touch v11 if this installer is run more than once.
if [ -f app/Services/Servers/ServerCreationService.php ] && ! grep -q 'kahfimoodtzyy server owner admin self only guard v11' app/Services/Servers/ServerCreationService.php; then
...
$marker = 'KAHFIMOODTZYY_PANEL_PROTECT_BOOT_V11';
...
kahfi_patch_handle_guard(
    ...
    'kahfimoodtzyy server owner admin self only guard v11',
    <<<GUARD
        // kahfimoodtzyy server owner admin self only guard v11
{$actor}
        // Admin selain utama boleh create server untuk user manapun.
...
============================================================
kahfimoodtzyy FULL PROTECT v11 SELESAI
============================================================
