...
# ==========================================================
# kahfimoodtzyy Full Protect + Same Admin Theme v10
#
# RULE FINAL:
# Admin utama:
# - full akses semua
...
#
# Install:
#   MAIN_ADMIN_ID=1 bash kahfi-full-protect-same-theme-final-v10.sh
# atau:
#   MAIN_ADMIN_ID=1 bash kahfi-full-protect-same-theme-final-v10.sh /var/www/pterodactyl
# ==========================================================
...
$marker = 'KAHFIMOODTZYY_PANEL_PROTECT_BOOT_V10';
...
kahfi_patch_handle_guard(
    ...
    'kahfimoodtzyy server owner admin self only guard v10',
    <<<GUARD
        // kahfimoodtzyy server owner admin self only guard v10
{$actor}
        // Admin selain utama boleh create server untuk user manapun.
