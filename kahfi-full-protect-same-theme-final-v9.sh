...
# ==========================================================
# kahfimoodtzyy Full Protect + Same Admin Theme v9
#
# RULE FINAL:
# Admin utama:
# - full akses semua
...
#
# Install:
#   MAIN_ADMIN_ID=1 bash kahfi-full-protect-same-theme-final-v9.sh
# atau:
#   MAIN_ADMIN_ID=1 bash kahfi-full-protect-same-theme-final-v9.sh /var/www/pterodactyl
# ==========================================================
...
# Disable old v7/v8 owner restriction if this script is installed over a previous version.
# v9 allows admin selain utama to create server for any user; only list/detail/delete are blocked.
...
class KahfiMoodTzyPanelProtect
{
    public function handle(Request $request, Closure $next): Response
    {
         ...
         * Larangan tetap hanya di list/detail/delete/delsrv server.
         */
...
$marker = 'KAHFIMOODTZYY_PANEL_PROTECT_BOOT_V9';
...
kahfi_patch_handle_guard(
    ...
    'kahfimoodtzyy server create any owner allowed guard v9',
    <<<GUARD
        // kahfimoodtzyy server create any owner allowed guard v9
        // Admin selain utama boleh create server untuk user manapun.
        // Proteksi list/detail/delete/delsrv ada di middleware dan ServerDeletionService.
GUARD
);
...
3. Admin selain utama create server untuk user manapun via panel/PTLA: harus bisa.
